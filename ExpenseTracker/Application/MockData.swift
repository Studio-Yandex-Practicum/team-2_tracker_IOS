...
var expensesMockData: [Expense] = [
    Expense(id: UUID(), expense: 5500, category: "Продукты", date: Date(timeIntervalSinceNow: -86400), note: "Примечание"),
    Expense(id: UUID(), expense: 3500, category: "Продукты", date: Date(timeIntervalSinceNow: -86400), note: ""),
    Expense(id: UUID(), expense: 1000, category: "Дом", date: Date(timeIntervalSinceNow: -86400), note: "Примечание"),
    
    Expense(id: UUID(), expense: 1000, category: "Транспорт", date: Date(timeIntervalSinceNow: -864065), note: "Примечание"),
    Expense(id: UUID(), expense: 3500, category: "Транспорт", date: Date(timeIntervalSinceNow: -86400), note: ""),
